...
class Penilaian_model extends CI_Model
{
	...
	public function get($condition = [])
	{
		...
		$this->db->join('jenis_kriteria d', 'd.id = b.id_jenis_kriteria', 'inner');
	...
	{
		$this->db->select('DISTINCT c.id, c.nis, c.nama', FALSE);
		$this->db->from("$this->_table a");
		$this->db->join('siswa c', 'c.id = a.id_siswa', 'inner');
	...
	// cari nilai berdasarkan id siswa dan id kriteria
	...
	// menghitung nilai rata-rata siswa tiap core factor dan secondary factor
