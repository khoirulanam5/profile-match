						...
						<div class="card-body">
							<!-- <form class="row" method="get">
								...
								<div class="col-3 form-group">
									...
									<a href="<?= base_url('laporan/print') ?>" target="_blank" onclick="download()" style="margin-top: 30px;" class="btn btn-warning"><i class="fa fa-print"></i> Cetak</a>
								</div>
...
function download() {
	...
	window.location.href = "<?= base_url(); ?>laporan/print/?tahun=" + tahun +"&jumlah= "+ jumlah +"&kelas=" + kelas;
}
</script>
